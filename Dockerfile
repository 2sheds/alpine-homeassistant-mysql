...
ARG DEPS
ARG PLUGINS="pyotp|PyQRCode|sqlachemy|wakeonlan|paho-mqtt|pysnmp|apcaccess|pushover_complete|hbmqtt|pyfttt|pyemby|steamodd|hole|HAP-python|PyQRCode|fnvhash|base36|aiohomekit|ha-ffmpeg|PyTurboJPEG|pywebpush|holidays|colorlog|pysonos|plexapi|plexauth|plexwebsocket|hkavr|garminconnect|spotipy|samsungctl|samsungtvws|mutagen|pycsspeechtts|pyipp|async-upnp-client|pyowm|emoji|pillow"
ARG ALPINE_VER="3.10"
