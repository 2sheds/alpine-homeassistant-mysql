...
ARG DEPS="shadow"
ARG PLUGINS="ass-nabucasa|HAP-python|pysnmp|async-upnp-client|apcaccess|netdisco|pushover_complete|hbmqtt|mutagen|libsoundtouch|pyfttt|pyemby|steamodd|hole|homekit|PyNaCl|gTTS-token|pywebpush|py_vapid|holidays|colorlog|zeroconf|pysonos|pybluez|miflora|bluepy|bt_proximity|pygatt|hkavr|garminconnect|spotipy|samsungctl|samsungtvws"
ARG ALPINE_VER="3.10"
